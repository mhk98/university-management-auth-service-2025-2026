...
userSchema.methods.isUserExist = async function (id:string): Promise<Pick<IUser, 'id' | 'password' | 'role' | 'needsPasswordChange'> | null> {
const user = await User.findOne ({id}, {id:1, role:1, needsPasswordChange:1}).lean();
